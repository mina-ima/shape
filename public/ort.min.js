...
var ort = (() => {
  ...
  var dt = (e) => Wu(wn({}, "__esModule", { value: !0 }), e);
  var xt,
    je,
    We,
    Gu,
        ...
        (Br = () => {
          if (!zr) {
            ...
            let e = typeof BigInt64Array < "u" && BigInt64Array.from,
              ...
              r = typeof n < "u" && n.from;
            (e &&
              (Ze.set("int64", BigInt64Array), lt.set(BigInt64Array, "int64")),
              t &&
                (Ze.set("uint64", BigUint64Array),
                lt.set(BigUint64Array, "uint64")),
              r
                ? (Ze.set("float16", n), lt.set(n, "float16"))
        ...
        async run(t, n, r) {
          ...
          for (let d in a)
            if (Object.hasOwnProperty.call(a, d)) {
              ...
              l instanceof ve
                ? (u[d] = l)
                : (u[d] = new ve(l.type, l.data, l.dims));
            }
  ...
  var Kr,
    ...
    Qr = k(() => {
      ...
      Hu = jr
        ? null
        : (e) => new Worker(e ?? be, { type: "classic", name: Kr });
    });
  var qu,
    Fu,
    be,
  ...
  var cd,
    ...
    Ve = k(() => {
      ...
      ((cd = (e, t) => {
        ...
        (pd = (e, t) => x.sortBasedOnPerm(e, Io(e.length, t))),
        (md = (e, t, n, r) => {
...
`)}`,
        ...
        (No = (e, t) => {
          Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes)
            ? zd(e, t)
            : Eo(e, t);
        }),
        (Lo = (e, t) => {
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
        ...
        (ot = (e, t, n, r, o, i, s, a, u, d, l = void 0, c = void 0) => {
          ...
          e.compute(
            Rd(y, d.batchSize, d.numHeads, f, d.sequenceLength, m, l, c),
        ...
        (bs = (e, t, n, r) => {
          ...
          if (
            ...
            M < 8 && U < 8
              ...
              : e.compute(bt(z, n, i, A, o, r), { inputs: z });
            return;
          }
          let b = !0,
            y =
  ...
  var kl,
    ...
    Ns = k(() => {
      ...
      ((kl = (e) => {
        ...
        (Pl = (e, t) => (e.length > t.length ? Rs(e, t) : Rs(t, e))),
        (zl = (e) => {
          let t = e[0].dims,
            n = Array.from(e[1].getBigInt64Array(), Number),
            r = Pl(t, n),
...
`),
  ...
  var ge,
    ...
    sr = k(() => {
      ...
      K();
      Ve();
      ((ge = (e, t) => (e.length > t && e[t].dims.length > 0 ? e[t] : void 0)),
        (Jl = (e, t) => {
          let n = e[0],
            r = ge(e, 1),
            o = ge(e, 2),
  ...
  var pn,
    ...
    Ha = k(() => {
      ...
      ((pn = (e) => {
        ...
        (Tc = (e) => `${Pa(e)};${e.countIncludePad}`),
        (Ic = (e) => `${Pa(e)};${e.storageOrder};${e.dilations}`),
        (za = (e) => ({
          format: e.format,
        ...
        (Ra = (e, t) => {
          (pn(e.inputs),
            e.compute(Ba("GlobalAveragePool", e.inputs[0], !0, t)));
        }),
        (Va = (e, t, n, r) => {
          let [o, i] = Aa(t, r, n),
            s = `
      ...
      ((kc = (e, t, n) => {
        ...
        (ja = (e) => {
          ...
          (e.inputs[0].dataType === 6
            ...
            te.webgpu.validateInputContent && kc(t, n, r),
      ...
      ((Dc = (e, t) => {
        ...
        (Mc = (e, t, n, r, o, i) => {
          ...
          if (
            ...
            (Dc(r, t),
              t.axes.length > 0 &&
                Oc(r, t.axes, d).forEach((l, c) => (r[c] = l)));
          }
          if (
            u > 0 &&
            e.length > u &&
...
${a}`,
        ...
        (pr = class {
          ...
          compute(t, n) {
            let r =
              ...
              o = n?.outputs ?? [],
              i = (a, u, d) => new wt(this.module, u, this.output(a, d), d),
              s = (a, u) => {
                let d = qe(a, u);
          ...
          try {
            if (
              ...
              for (let v of t.externalData) {
                ...
                w.push(
                  ht(typeof v == "string" ? v : v.data).then((T) => {
        ...
        (Bt = async (e, t, n, r, o, i) => {
          ...
          try {
            ...
            if (p && !m) {
              ...
              (Re("wasm bindInputsOutputs"), et.set(e, [d, l, c, p, f, !0]));
            }
              ...
              try {
                ...
                if (R === "string") {
                  ...
                  for (let ae = 0; ae < $e; ae++) {
                    let Le = s.getValue(Q + ae * a, "*"),
                      vt = s.getValue(Q + (ae + 1) * a, "*"),
                      gr = ae === $e - 1 ? void 0 : vt - Le;
                  ...
                  ((Z = !0),
                    U.push([
                      ...
                      {
                        gpuBuffer: ae,
                        download: s.jsepCreateDownloader(ae, Le, R),
                        dispose: () => {
  ...
  var tt,
    ...
    hr = k(() => {
      ...
      Ge();
      Ct();
      ((tt = () => !!te.wasm.proxy && typeof document < "u"),
        ($t = !1),
        (gn = !1),
        (yn = !1),
        (fr = new Map()),
        ...
        (Cu = async () => {
          if (!gn) {
            ...
            try {
              (await At(te.wasm), await Et(te), (gn = !0));
            } catch (e) {
              throw ((yn = !0), e);
            } finally {
              $t = !1;
  ...
  Object.defineProperty(te.versions, "web", { value: Fr, enumerable: !0 });
  return dt(_p);
})();
/**
 * @license
